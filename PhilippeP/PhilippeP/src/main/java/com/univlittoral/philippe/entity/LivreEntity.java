package com.univlittoral.philippe.entity;
...
@Entity
@Table(name="bibliopthequep") //=> le nom de la table de votre base de données associée à cet objet Entité.
...
public class LivreEntity {
	...
	public void setNombredepages(Integer nbPages) {
